...
export class StoreFeedComponent implements OnInit {
 ...
 enableButton:boolean =false;
  ...
  submit() {
    //Call Service
    // this.excelFile=excelFileTemp
    // console.log("file name");
    // console.log(this.excelFile.name);
    let formData: FormData = new FormData();
    formData.append('files' , this.data.excelFile);
    formData.append('excelFile', this.data.excelFile);
     debugger;
    console.log(formData);
    this.simulatorService.addMultipleClinics(formData).subscribe(data => {
    ...
    debugger;
    console.log('multiple clinic data',this.data);
